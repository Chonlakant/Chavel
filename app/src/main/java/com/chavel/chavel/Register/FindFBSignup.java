...
public class FindFBSignup extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_find_fbsignup);
        buttonEvent();
        assignLinkInText();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_find_fbsignup, menu);
        return true;
    }
    ...
    public void assignLinkInText(){
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View textView) {
                Intent next = new Intent(getApplicationContext(),FindContactsSignup.class);
                startActivity(next);
            }
            @Override
